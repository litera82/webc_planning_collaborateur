        ...
        <td width="620" height="418" colspan="4" valign="top" bgcolor="#FFFFFF">
        	<p style="padding:15px 40px; margin:0; text-align:justify;">
                <font face="Verdana, Geneva, sans-serif" size="2">
					...
					Vous êtes inscrit(e) en tant que projet. Vous pouvez maintenant visionner vos cours planifiés avec votre collaborateur <b>{$oUtilisateur->utilisateur_zNom} {$oUtilisateur->utilisateur_zPrenom}</b> en vous connectant sur : <a href="http://{$zUrlToIndexStagiaire}" target="_blank" style="text-decoration:none;color:#003399;">Planning en ligne/Forma2+</a><br /><br /><br />
					<ul>
