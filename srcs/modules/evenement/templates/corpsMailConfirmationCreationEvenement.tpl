        ...
        <td width="620" height="418" colspan="4" valign="top" bgcolor="#FFFFFF">
        	<p style="padding:15px 40px; margin:0; text-align:justify;">
                <font face="Verdana, Geneva, sans-serif" size="2">
					Bonjour ,<br /><br />
					Votre {$oTypeEvenement->typeevenements_zLibelle} est programmé pour le {$zDate} à {$zHeure} avec {$oUtilisateur->utilisateur_zNom} {$oUtilisateur->utilisateur_zPrenom}<br />
					{if isset ($tEvent->evenement_zContactTel) && $tEvent->evenement_zContactTel != ''}
					Votre collaborateur vous appellera au {$tEvent->evenement_zContactTel}<br /><br />
					{/if}
                </font>
				<br /><br />
				<font face="Verdana, Geneva, sans-serif" size="1">
					<b>Recommandation :</b><br />
					Les cours individuels peuvent être reportés et ne sont pas perdus si le projet prévient <u><b>directement</b> son collaborateur</u>, l'avant-veille avant 17h (jours ouvrés) pour les cours face à face, et la veille avant 17h (jours ouvrés) pour les cours téléphone ou tutorés. Dans un souci d'efficacité, il est conseillé de le reporter la même semaine ou la semaine suivante.
					<br /><br />
				</font>
