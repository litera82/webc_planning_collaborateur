...
class Calendar{
	...
	/* CONSTRUCTOR */
	function Calendar($date = NULL, $year = NULL, $month = NULL, $iAffichage = 1){
			...
			switch( $this->link_days ){
				...
				case 1 :
					if( empty($this->formatted_link_to) ){
						$output .= "<a href=\"" . $this->link_to . "?date=" . $day_date . "&iAffichage=".$this->iAffichage."\">" . $day . "</a>";
					} else {
						$output .= "<a href=\"" . strftime($this->formatted_link_to, strtotime($day_date)) . "&iAffichage=".$this->iAffichage."\">" . $day . "</a>";
					}
				break;
				...
				case 2 :
					if( is_array($this->highlighted_dates) ){
						if( in_array($day_date, $this->highlighted_dates) ){
							if( empty($this->formatted_link_to) ){
								$output .= "<a href=\"" . $this->link_to . "?date=" . $day_date . "&iAffichage=".$this->iAffichage."\">";
							} else {
								$output .= "<a href=\"" . strftime($this->formatted_link_to, strtotime($day_date)) . "&iAffichage=".$this->iAffichage."\">";
							}
						}
					}
